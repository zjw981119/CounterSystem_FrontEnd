<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>挖机油量表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图区 -->
    <el-card>
      <!-- 日期选择与查询 -->
      ...
      <!-- 配置列表区域 -->
      <el-table :data="diggerfuelList" border stripe :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}" height="480">
...
export default {
  ...
  created() {
    ...
    this.getDiggerConfig()
  },

  methods: {
    //获取挖机配置信息请求
    async getDiggerConfig() {
      this.diggerConfiglist = new Array()
    //   var that = this
    ...
    //     return that.$message.error('获取挖机配置表失败')
    //   }
